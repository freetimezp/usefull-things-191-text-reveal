document.addEventListener("DOMContentLoaded", () => {
    ...
    const animeTexts = document.querySelectorAll(".anime-text p");
            ...
            onUpdate: (self) => {
                ...
                words.forEach((word, index) => {
                    ...
                    if (progress <= 0.7) {
                        ...
                        word.style.visibility = wordProgress > 0 ? "visible" : "hidden";
                        ...
                        wordText.style.visibility = textRevealProgress > 0 ? "visible" : "hidden";
                    } else {
